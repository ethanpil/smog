...
# If left empty, it defaults to a path in the user's config directory (e.g., ~/Library/Application Support/smog/token.json).
GoogleTokenPath = ""
...
# Port 25 may require root privileges. Use a higher port like 587 or 2525.
SMTPPort = 2525
